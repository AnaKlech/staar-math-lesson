      ...
      "topics": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "correct": 1,
              "explain": {
                "0": "Тут числа не віднімають, а додають. Питання просить РІЗНИЦЮ між найбільшим і найменшим значенням — тобто віднімання, а не суму.",
                "2": "Перевір, чи справді обрані саме найбільше і найменше значення зі списку, а не якісь інші два.",
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "У вихідному списку немає числа 50 — перевір ще раз, які саме числа мають стебло 5.",
            ...
            },
            {
              ...
              "explain": {
                ...
                "1": "Групування за стеблом тут правильне, але листки в рядку мають йти за ЗРОСТАННЯМ (від меншого до більшого), а не в довільному порядку.",
                "2": "Перевір, яка частина числа — стебло (перші цифри), а яка — листок (остання цифра): тут вони, схоже, переплутані місцями."
              },
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "Тут не враховано, що значення 22°C зустрічається двічі — у діаграмі воно записане двома окремими листками, тому має рахуватись двічі.",
                "2": "Це кількість днів з іншого рядка діаграми (стебло 3, тобто 30–39°C), а не з рядка 20–29°C.",
                "3": "8 — це загальна кількість усіх днів у списку за весь період, а не лише тих, що потрапляють у діапазон 20–29°C."
              },
          ...
          "questions": [
            {
              ...
              "correct": 1,
              "explain": {
                "0": "У вихідному списку немає жодного числа 2 — а в цій таблиці для значення 2 стоїть позначка. Порівняй кожен рядок зі списком уважно.",
                ...
                "3": "Порахуй ще раз, скільки разів рівно значення 4 зустрічається у списку — тут якогось входження бракує."
              },
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "У діапазоні 0–4 зі списку є лише одне число (2) — цей рядок відповідає даним правильно.",
                "1": "У діапазоні 5–9 зі списку є три числа (5, 7, 9) — цей рядок відповідає даним правильно.",
            ...
            },
            {
              ...
              "explain": {
                "0": "10 — це загальна кількість УСІХ учнів у таблиці, включно з тими, хто прочитав менше 3 книжок.",
                "1": "Це кількість учнів, які прочитали РІВНО 4 книжки — а питання просить 3 АБО БІЛЬШЕ, тобто варто додати ще й тих, хто прочитав рівно 3.",
                "2": "Це кількість учнів, які прочитали РІВНО 3 книжки — а питання просить 3 АБО БІЛЬШЕ, тобто потрібно додати ще й тих, хто прочитав 4."
              },
              "correct": 3,
          ...
          "questions": [
            {
              ...
              "correct": 0,
              "explain": {
                "1": "8/5 — це більше за одне ціле (чисельник більший за знаменник), тож це точно не менше за 5/8.",
                "2": "5/6 і 5/8 мають ОДНАКОВИЙ чисельник (5). Коли чисельники однакові, дріб з МЕНШИМ знаменником — БІЛЬШИЙ, а не менший (адже частини цілого більші). Перевір напрямок цього правила ще раз.",
                "3": "Порівняй чисельники при однаковому знаменнику (8): який із них — 7 чи 5 — більший?"
              },
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "Це звужує коло лише до Лізи — але перевір результат Соні (3/4) окремо, порівнявши його з 2/3, перш ніж вирішувати, кого саме включати.",
                "1": "Перевір результат Максима (5/9) окремо, порівнявши його зі значенням 2/3.",
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "Перевір кожен результат окремо: принаймні один із чотирьох виходить за межі діапазону від 1/2 до 4/5.",
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "Спочатку додай частки з корицею і з маком (звівши до спільного знаменника), а потім відніми результат від цілого (1), щоб знайти частку звичайних булочок — і порівняй її з половиною.",
                "2": "У задачі сказано, що решта булочок — звичайні, тобто якась їх кількість точно є. Перевір, чи справді сума часток з корицею і маком дорівнює цілому (1).",
                "3": "Перевір суму 1/4 + 2/5 ще раз, звівши дроби до спільного знаменника — здається, результат не зовсім дорівнює половині."
              },
          ...
          "questions": [
            {
              ...
              "correct": 1,
              "explain": {
                "0": "12 — це загальна кількість шматків з УСІХ трьох кавунів, а не кількість шматків, які з'їли діти. Порахуй, скільки шматків з'їли саме діти.",
                "2": "12 — це загальна кількість шматків з усіх кавунів, а не кількість шматків в ОДНОМУ цілому кавуні. Знаменник має показувати, на скільки частин розрізали ОДИН кавун, а не скільки всього шматків існує.",
                "3": "Тут переставлено місцями чисельник і знаменник. Подумай ще раз: чисельник має показувати, СКІЛЬКИ шматків з'їли діти, а знаменник — скільки шматків становлять ОДИН цілий кавун — яке з цих двох чисел де стоїть?"
              },
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "Це рівняння додає зафарбовані і незафарбовані клітинки разом, що завжди дасть усе поле (24/24) — це не показує, яку ЧАСТКУ зафарбовано.",
                "1": "Перевір додавання чисельників ще раз: 3+2+4+1 — порахуй уважно кожен доданок.",
                "3": "Кожен доданок має знаменник, що дорівнює ЗАГАЛЬНІЙ кількості клітинок на малюнку (24), а не кількості клітинок лише в одному рядку (6)."
              },
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "15 — це лише кількість яблук, а не загальна кількість УСІХ фруктів у кошику. Знаменник має бути загальною кількістю фруктів (груші + яблука разом).",
                "1": "15/20 показує частку ЯБЛУК серед усіх фруктів, а питання просить частку ГРУШ.",
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "40 — це лише час на математику, а не ЗАГАЛЬНИЙ час на обидва заняття. Знаменник має включати і математику, і читання разом.",
                "2": "40/60 показує частку часу на МАТЕМАТИКУ від загального часу, а питання просить частку часу на ЧИТАННЯ.",
                "3": "Тут чисельник і знаменник переставлені місцями. Чисельник має бути часом на читання (частина), а знаменник — загальним часом на обидва заняття (ціле)."
              },
      ...
      "topics": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "60 — це загальна кількість закладок УСІХ гуртків разом, а не закладок ОДНОГО гуртка. Потрібно ще поділити на кількість гуртків (5).",
                "1": "36 — це аркушів на один гурток, а не закладок. Спочатку варто знайти загальну кількість ЗАКЛАДОК (аркуші ÷ 3), а вже потім ділити на гуртки.",
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "Ця пара дій двічі використовує додавання і взагалі не враховує, що у вівторок книг мало бути в 4 рази більше — тут немає жодного множення на 4.",
                "1": "Тут другий крок — множення замість додавання. Щоб знайти ЗАГАЛЬНУ кількість книг за два дні, потрібно ДОДАТИ кількість за понеділок і за вівторок, а не перемножити їх.",
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "9 — це кількість мотків стрічки, а не кількість нарізаних шматків по 4 метри.",
                "2": "135 — це загальна довжина стрічки в метрах, а не кількість шматків по 4 метри. Потрібно ще поділити цю довжину на 4.",
                "3": "135 ÷ 4 = 33,75 — кількість шматків має бути ЦІЛИМ числом. Округлення ВГОРУ тут не підходить: подумай, чи вистачить довжини стрічки на ще один повний 4-метровий шматок понад цілу частину результату ділення."
              },
            ...
            },
            {
              ...
              "correct": 1,
              "explain": {
                "0": "252 — це загальна кількість крісel у залі, а не кількість ГРУП по 6 крісел. Потрібно ще поділити цю кількість на 6.",
          ...
          "questions": [
            {
              ...
              "correct": 2,
              "explain": {
                "0": "Тут враховано лише тих, хто ПРИЙШОВ, а тих, хто ПІШОВ — не віднято жодного разу. Прочитай умову ще раз: у 2-гу і 3-тю годину частина відвідувачів залишила бібліотеку.",
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "Це сума самих ЗАБРАКОВАНИХ деталей, а питання запитує про ЯКІСНІ деталі, які залишились, а не про брак.",
          ...
          "questions": [
            {
              ...
              "correct": 1,
              "explain": {
                "0": "Прямокутний трикутник має лише ОДИН прямий кут — а задача просить фігуру з РІВНО ДВОМА прямими кутами.",
                "2": "Ромб зазвичай не має жодного прямого кута (хіба що він одночасно є квадратом) — це не відповідає умові «рівно два».",
            ...
            },
            {
              ...
              "explain": {
                ...
                "2": "Усі кути правильного п'ятикутника тупі (по 108°) — тут немає жодного гострого чи прямого кута."
              },
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "Ромб зазвичай не має жодного прямого кута — лише всі сторони однакової довжини, а кути можуть бути гострими й тупими.",
                "2": "Рівносторонній трикутник має лише ТРИ кути, і всі вони гострі (по 60°) — прямих кутів там взагалі немає.",
                "3": "Прямокутна трапеція має лише ДВА прямих кути, а не чотири."
              },
          ...
          "questions": [
            {
              ...
              "explain": {
                ...
                "2": "110° — це значення з ІНШОЇ шкали транспортира (тієї, що починається з 0 ліворуч). Промінь OP лежить праворуч, тому читай число з шкали, яка починається з 0 саме праворуч.",
                "3": "Перевір ще раз, на яку саме поділку показує промінь OQ — здається, тут узято сусідню поділку."
              },
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "150° — це значення з ІНШОЇ шкали транспортира (тієї, що починається з 0 праворуч). Промінь OP лежить ЛІВОРУЧ, тому читай число з шкали, яка починається з 0 саме ліворуч.",
                "1": "Перевір ще раз, на яку саме поділку показує промінь OQ — здається, тут узято сусідню поділку.",
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "Перевір ще раз, на яку саме поділку показує промінь ON — здається, тут узято сусідню поділку.",
                "1": "Перевір ще раз, на яку саме поділку показує промінь ON — здається, тут узято поділку в інший бік.",
                "2": "140° — це значення з ІНШОЇ шкали транспортира (тієї, що починається з 0 ліворуч). Промінь OM лежить праворуч, тому читай число з шкали, яка починається з 0 саме праворуч."
              },
            ...
            },
            {
              ...
              "explain": {
                "1": "Перевір ще раз, на яку саме поділку показує промінь ON — здається, тут узято поділку в інший бік.",
                "2": "160° — це значення з ІНШОЇ шкали транспортира (тієї, що починається з 0 праворуч). Промінь OM лежить ЛІВОРУЧ, тому читай число з шкали, яка починається з 0 саме ліворуч.",
                "3": "Перевір ще раз, на яку саме поділку показує промінь ON — здається, тут узято сусідню поділку."
              },
      ...
      "topics": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "correct": 2,
              "explain": {
                "0": "Тут переставлено місцями цілу частину і дріб. Подивись на запис 6.045 ще раз: яка з двох частин (до коми чи після) є цілою?",
                "1": "6 450/1000 означає 6.450, а не 6.045 — тут дріб має на одну цифру більше, ніж потрібно.",
                "3": "45/100 означає 0.45 — а це не те саме, що 0.045. Порахуй, скільки цифр стоїть після коми у числі 6.045, і який розряд це визначає."
              },
            ...
            },
            {
              ...
              "correct": 3,
              "explain": {
                "0": "Перевір ще раз, яка саме цифра стоїть одразу після коми (у розряді десятих) — здається, тут узято іншу цифру.",
            ...
            },
            {
              ...
              "explain": {
                ...
                "2": "Слова «сотень» і «сотих» звучать схоже, але це РІЗНІ розряди: сотні — розряд великого цілого числа, соті — маленька частка після коми. Тут цифри 9 і 2 переплутані місцями саме через цю схожість слів.",
                "3": "Тут цифра 9 стоїть у розряді ДЕСЯТИХ (перша цифра після коми), а вона мала бути в розряді СОТИХ (друга цифра після коми)."
              },
          ...
          "questions": [
            {
              ...
              "correct": 2,
              "explain": {
                "0": "Перевір цю відповідь на кількох рядках: 1×6=6 (а має бути 23) — не співпадає.",
                ...
                "3": "Перевір цю відповідь на кількох рядках: 1×23=23 (підходить), але 2×23=46 (а має бути 24) — не співпадає."
              },
            ...
            },
            {
              ...
              "explain": {
                ...
                "1": "Перевір останній рядок окремо: 4×14 = 56, а в таблиці для позиції 4 має вийти 52.",
            ...
            },
            {
              ...
              "correct": 0,
              "explain": {
                "1": "Перевір множення ще раз: 9 метрів, і кожен метр — це 100 см. Порахуй 9×100 уважно.",
                "2": "90 — це так, ніби один метр дорівнює лише 10 см. Перевір таблицю ще раз: скільки сантиметрів відповідає, наприклад, 2 метрам?",
                "3": "109 виглядає так, ніби до 9 просто додали 100 — але правило тут МНОЖЕННЯ (кожен метр = 100 см), а не додавання одного й того самого числа."
              },
            ...
            },
            {
              ...
              "correct": 1,
              "explain": {
                "0": "Тут враховано лише множення (4×6=24), але забуто додати сталу частину правила (+1).",
                "2": "21 — це значення для ПОЗИЦІЇ 5 (17+4=21), а питання запитує про позицію 6 — потрібно застосувати правило ще на один крок далі.",
                "3": "Перевір, для якої саме позиції виходить це значення — здається, тут порахована позиція 7, а не 6."
              },
